          ...
          >
            ...
            {recepcaoView === "calendar" ? (
              <>
                ...
                <div className="flex-1 min-h-0 grid grid-cols-7 grid-rows-6 gap-px p-1">
                  {calendarDays.map((dayInfo, index) => {
                    ...
                    return (
                      <button
                        key={index}
                        onClick={() => dayInfo.month === "current" && handleMobileDayClick(dayInfo.date)}
                        disabled={dayInfo.month !== "current"}
                        className={cn(
                          "relative flex flex-col items-center justify-center transition-all rounded-lg overflow-hidden",
                          ...
                          dayInfo.month === "current" && truckCount > 0
                            ? hasIncomplete
                              ? isDarkMode
                                ? "hover:bg-rose-500/25 active:bg-rose-500/30 bg-rose-500/18 border border-rose-500/25"
                                : "hover:bg-rose-200 active:bg-rose-300 bg-rose-100 border border-rose-300"
                              : isDarkMode
                                ? "hover:bg-emerald-500/20 active:bg-emerald-500/25 bg-emerald-500/15 border border-emerald-500/25"
                                : "hover:bg-emerald-200 active:bg-emerald-300 bg-emerald-100 border border-emerald-300"
                            : "",
                          dayInfo.month === "current" && truckCount === 0
                            ? isPastDate
                              ? isDarkMode
                                ? "hover:bg-slate-700/30 active:bg-slate-700/40 bg-slate-800/40 border border-slate-600/40"
                                : "hover:bg-slate-200 active:bg-slate-300 bg-slate-100 border border-slate-200"
                              : isDarkMode
                                ? "hover:bg-white/10 active:bg-white/15 bg-white/5 border border-white/5"
                                : "hover:bg-gray-100 active:bg-gray-200 bg-transparent border border-transparent"
                            : "",
                          isToday
                            ? isDarkMode
                      ...
                      >
                        ...
                        {dayInfo.month === "current" && (
                          <div className="flex items-center gap-1 mt-0.5">
                            {truckCount > 0 ? (
                              <span className={`text-[11px] font-semibold ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>
                                {truckCount}
                              </span>
                            ) : isPastDate ? (
              ...
              <div className={`flex-1 min-h-0 overflow-y-auto p-4 ${isDarkMode ? "bg-[#050816]" : "bg-gray-50"}`}>
                <div className="space-y-4">
                  {/* Card Entradas */}
                  <div className={`rounded-2xl p-5 border-2 ${isDarkMode ? "bg-gradient-to-br from-slate-800/80 to-slate-900/80 border-slate-700/50" : "bg-gradient-to-br from-white to-gray-50 border-gray-200"} shadow-sm`}>
