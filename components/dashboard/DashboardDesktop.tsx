            ...
            <div className="flex-1 overflow-auto calendar-scroll">
              <div className="grid h-full grid-cols-7 auto-rows-fr min-h-0">
                      {weekDays.map((day) => (
                        <div
                          key={day}
                          className={`sticky top-0 z-10 flex items-center justify-center py-2 text-xs sm:text-sm font-semibold border-b border-r ${isDarkMode ? "bg-slate-800/95 text-gray-400 border-white/10" : "bg-gray-50 text-gray-600 border-gray-200"}`}
                        >
                          {day}
                        </div>
                      ))}
                      ...
                      {isCurrentMonth && truckCount > 0 && (
                        <div className="flex-1 flex items-start">
                          <div className={`relative inline-flex items-center gap-2 px-3 py-2 rounded-full transition-all duration-200 group-hover:scale-105 group-hover:shadow-md ${
                            ...
                            />
                            <TruckIcon className={`h-4 w-4 sm:h-4.5 sm:w-4.5 shrink-0 ${iconColorClasses}`} />
                          ...
                          <div className="p-3 w-full">
                            ...
                            <div className="flex items-center gap-2 mb-2 pb-2 border-b border-gray-200/20">
                              ...
                              <p className={`text-[11px] font-bold ${isDarkMode ? "text-white" : "text-gray-900"}`}>
                                {truckCount} {truckCount === 1 ? "caminhão" : "caminhões"}
                              </p>
                            </div>
